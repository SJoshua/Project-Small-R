...
local addsticker = {
    func = function(msg)
        ...
        local default_title =
            (output_fn == "sticker.png" and "" or "Animated ") ..
                ("Sticker Pack By " .. msg.from.first_name ..
                    (msg.from.last_name and (" " .. msg.from.last_name) or ""))
        ...
        while c < 10 do
            ...
            elseif (ret.result.is_animated and is_animated and
                #ret.result.stickers < 50) or
                (ret.result.is_video and is_video and #ret.result.stickers < 50) or
                (not ret.result.is_animated and not ret.result.is_video and
                    is_static and #ret.result.stickers < 120) then
                local args = {
                    user_id = msg.from.id,
                    name = url,
                    emojis = "🍀"
            ...
            if continue then
                ...
                local pack_url =
                    "[" .. title .. "](https://t.me/addstickers/" .. url .. ")"
